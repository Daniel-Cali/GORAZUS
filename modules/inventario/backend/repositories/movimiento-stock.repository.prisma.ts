...
export class MovimientoStockRepositoryPrisma extends MovimientoStockRepository {
   ...
   * — Parte 03, transferencias con varias líneas: o se aplican todas o
   * ninguna, nunca una transferencia a medio aplicar).
   */
  private async aplicarMovimiento(
    ...
    // Parte 03 (Reservas): una salida nunca puede dejar `quantity_on_hand`
    // por debajo de lo reservado para otros — comparar contra "disponible"
    // (a mano - reservado), no contra "a mano" a secas (fix del TODO
    // dejado en Parte 02, ver INVENTORY_STOCK_REPORT.md §4 de esta parte).
