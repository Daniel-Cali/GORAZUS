...
export interface InventoryKpiCardProps {
  ...
  icon: LucideIcon;
  nivel?: NivelEstado;
  /** Comparación contextual corta — nunca solo el número, siempre con marco temporal/de referencia (regla de la misión: "value / contextual comparison / status"). */
  contexto?: string;
  trend?: number;
  onAction?: () => void;
  actionLabel?: string;
...
/**
 * Componente insignia del strip de KPIs — barra de acento a la izquierda
 * (color = nivel semántico) en vez de un ícono centrado genérico de
 * dashboard SaaS. Deliberadamente denso: número grande + contexto + acción
 * rápida en el mismo bloque, para escaneo en menos de 5 segundos (regla de
 * validación de diseño de la misión).
 */
