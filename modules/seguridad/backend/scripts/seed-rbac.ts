...
const PERMISSIONS: Array<{ moduleCode: string; actionCode: string }> = [
  ...
  { moduleCode: 'proveedores', actionCode: 'gestionar_proveedores' },
  { moduleCode: 'compras', actionCode: 'gestionar_solicitudes' },
  { moduleCode: 'compras', actionCode: 'gestionar_ordenes' },
  { moduleCode: 'compras', actionCode: 'gestionar_recepciones' },
  { moduleCode: 'compras', actionCode: 'gestionar_facturas' },
  { moduleCode: 'compras', actionCode: 'gestionar_cotejos' },
  { moduleCode: 'compras', actionCode: 'gestionar_devoluciones' },
  { moduleCode: 'compras', actionCode: 'gestionar_notas_credito' },
  { moduleCode: 'compras', actionCode: 'gestionar_retenciones' },
  { moduleCode: 'compras', actionCode: 'gestionar_importaciones' },
  { moduleCode: 'clientes', actionCode: 'ver' },
  { moduleCode: 'clientes', actionCode: 'gestionar_clientes' },
  { moduleCode: 'clientes', actionCode: 'ver_contactos' },
  { moduleCode: 'clientes', actionCode: 'gestionar_contactos' },
  { moduleCode: 'clientes', actionCode: 'ver_direcciones' },
  { moduleCode: 'clientes', actionCode: 'gestionar_direcciones' },
  { moduleCode: 'clientes', actionCode: 'ver_cuentas_por_cobrar' },
  ...
  { moduleCode: 'crm', actionCode: 'gestionar_leads' },
  { moduleCode: 'crm', actionCode: 'ver_oportunidades' },
  { moduleCode: 'crm', actionCode: 'gestionar_oportunidades' },
  { moduleCode: 'crm', actionCode: 'ver_campanas' },
  { moduleCode: 'crm', actionCode: 'gestionar_campanas' },
  { moduleCode: 'crm', actionCode: 'ver_agenda' },
  { moduleCode: 'crm', actionCode: 'gestionar_agenda' },
  { moduleCode: 'contabilidad', actionCode: 'gestionar_plan_cuentas' },
  { moduleCode: 'contabilidad', actionCode: 'gestionar_asientos' },
  { moduleCode: 'contabilidad', actionCode: 'ver_reportes' },
];
