...
|                                 |                                                                                                                                                                                                                                                                                                                                                                                                  |
| ------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Identificador**               | `ADR-INV-001`                                                                                                                                                                                                                                                                                                                                                                                    |
| **Versión**                     | 1.0.0                                                                                                                                                                                                                                                                                                                                                                                            |
| **Estado**                      | Aceptada con Observaciones (2026-07-28, ver `docs/AKB/00 Governance/Enterprise Governance Report — 2026-07-28.md` §3 — observaciones: invariante I4 sin enforcement real, silencio sobre postura RLS/multiempresa)                                                                                                                                                                               |
| **Fecha**                       | 2026-07-27                                                                                                                                                                                                                                                                                                                                                                                       |
...
| **ADRs relacionados**           | `ADR-DB-001` (particionamiento de `sales.invoices`/`purchases.purchase_invoices` que referencian `product_id`), `ADR-INV-000` (Bounded Context de Inventario — Producto como subdominio de identidad), `ADR-INV-002` (Almacenes)                                                                                                                                                                 |
| **Dominios relacionados**       | Products, Inventory, Sales, Purchases, Accounting, Taxes, Assets, CRM                                                                                                                                                                                                                                                                                                                            |
| **Componentes relacionados**    | `core.documents`/`core.document_types`, `core.tags`/`core.entity_tags`, `core.files`, `product_attributes`/`product_attribute_values`                                                                                                                                                                                                                                                            |
| **Issues relacionados**         | `ISSUE-01` (Issue Register de Inventario): Invariante I4 (Lote XOR Serie) documentada sin implementar — referencia directa a este ADR y a `ADR-INV-000`                                                                                                                                                                                                                                          |
| **Patrones relacionados (AKB)** | `Dynamic Attribute Engine`, `Generic Polymorphic Subsystems`, `Domain Design Heuristics`, `Product`                                                                                                                                                                                                                                                                                              |
