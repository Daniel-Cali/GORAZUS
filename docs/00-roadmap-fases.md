...
| 20   | Producción                              | ✅ Completo                                 | [architecture/38-modulo-production.md](./architecture/38-modulo-production.md) — nota: Routing/Centro de Trabajo/MRP/Control de Calidad quedan explícitamente fuera (sin tabla real, pendientes de necesidad de negocio confirmada, ver documento §7)                                                                                                                                                                                                 |
...
| 27   | Inteligencia Artificial                 | ❌ Pendiente de definir alcance             | Confirmado explícitamente en esta conversación: no hay necesidad de negocio concreta todavía (¿forecasting sobre `bi.forecasts`? ¿asistente? ¿otra cosa?) — no se diseña especulativamente ([11-gobernanza-y-adrs §1](./architecture/11-gobernanza-y-adrs.md#1-cómo-se-agrega-un-módulo-nuevo))                                                                                                                                                       |
...
| ------------ | -------- | ------------------------------------------- |
| ✅ Completo  | 28       | 01-23, 24-25, 28, 31-32                     |
| 🟡 Parcial   | 1        | 30 (Pruebas — falta estrategia QA dedicada) |
| ❌ Pendiente | 3        | 26, 27, 29                                  |
