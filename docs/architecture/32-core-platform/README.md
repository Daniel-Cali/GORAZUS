...
| 14  | [14-motores-enterprise-avanzados.md](./14-motores-enterprise-avanzados.md)                   | Motores Enterprise avanzados          | BPM Engine, Document Management System, Digital Signature, Task Engine, Integration Engine — 5 motores nuevos pedidos en una "Fase 2" distinta (2026-07-21), ver [../FASE2_MOTORES_ENTERPRISE.md](../FASE2_MOTORES_ENTERPRISE.md) |

7 + 6 + 8 + 5 + 6 + 4 + 7 + 6 + 8 + 9 + 6 = **72 componentes** (01-11). 14 agrega 5 más = **77 componentes** en total del Core Platform.
